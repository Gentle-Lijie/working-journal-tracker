...
from shared.constants import LOG_FILE, PID_FILE, SESSION_STATUS_STOPPED
...
class TrackerDaemon:
    ...
    def __init__(self, session_id: int, repo_path: str):
    ...
    def start(self):
        ...
        logger.info(f"守护进程启动: session_id={self.session_id}, path={self.repo_path}")
    ...
    def _write_pid(self):
        ...
        logger.info(f"PID文件已写入: {pid_path}")
